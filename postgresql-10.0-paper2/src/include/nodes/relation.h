...
typedef struct PlannerInfo
{
	...
	/*modified by jim, we add rate_to_generate_explore_plan for explore plan*/
	double     rate_to_generate_explore_plan;
	int        search_plan_mode;  /*use aqo/default/cardlearner? modified by jim*/
	int        cardlearner_mode;
	double     cardlearner_similar_percent;
	int        levels_needed; /* modified by jim 2021.3.11*/
	Cost       best_estimate_cost_of_current_query;   /* best estimate corresponding to best true cost of current query, modified by jim 2021.3.11.*/
	double     rate_to_compare_best_est_cost;
	double     prune_rate_for_add_path_explore;
} PlannerInfo;
...
typedef struct RelOptInfo
{
    ...
    double      explore_value;      /* confidence that we can't get ture result tuples( writen by jim) */
	...
	//List       *explore_cost_pathslist; /* balance explore_value and cost ( writen by jim) */
	List       *cheapest_cost_explore_pathlist; /*Find cheapest cost paths in explore_cost_pathslist*/
...
typedef struct ParamPathInfo
{
	...
	double      ppi_explore_value; /*add by jim in 2021.1.27  explore value*/
} ParamPathInfo;
...
typedef struct Path
{
    ...
    /* explore value( writen by jim) */
	double      explore_value;
