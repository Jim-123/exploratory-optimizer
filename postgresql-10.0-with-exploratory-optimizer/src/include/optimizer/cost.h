...
/*modified by jim, inorder to calculate the explore_value*/
extern void initial_cost_nestloop_explore(PlannerInfo *root,
					  JoinCostWorkspace *workspace,
					  JoinType jointype,
					  Path *outer_path, Path *inner_path,
...
extern void initial_cost_mergejoin(PlannerInfo *root,
					   ...
					   JoinPathExtraData *extra);
extern void initial_cost_mergejoin_explore(PlannerInfo *root,
					   JoinCostWorkspace *workspace,
					   JoinType jointype,
					   List *mergeclauses,
					   Path *outer_path, Path *inner_path,
...
extern void initial_cost_hashjoin(PlannerInfo *root,
					  ...
					  Path *outer_path, Path *inner_path,
					  JoinPathExtraData *extra);
extern void initial_cost_hashjoin_explore(PlannerInfo *root,
					  JoinCostWorkspace *workspace,
					  JoinType jointype,
					  List *hashclauses,
					  Path *outer_path, Path *inner_path,
